...
def change():
    os.system("sudo /usr/sbin/service tor reload")
...
# 🔁 Start TOR service with sudo
os.system("sudo /usr/sbin/service tor start")
time.sleep(3)

print("\033[1;32;40m change your SOCKS to 127.0.0.1:9050 \n")

x = input("[+] time to change IP in Sec [type=60] >> ")
lin = input("[+] How many times do you want to change your IP? [Enter for infinite] >> ") or "0"
